...
struct cmd_type cmd_table [ ] = {
  ...
  { "afkmes",           do_afkmes,           POS_DEAD,         0, LOG_NORMAL, TRUE  },
  ...
  { "qui",              do_qui,              POS_DEAD,         0, LOG_NORMAL, TRUE  },
  ...
  { "save",             do_save,             POS_DEAD,         1, LOG_NORMAL, TRUE  },
  ...
  { "delet",            do_delet,            POS_STANDING,     0, LOG_NORMAL, TRUE  },
  ...
  { "imc",              do_imc,              POS_DEAD,     L_APP, LOG_NORMAL, TRUE  },
