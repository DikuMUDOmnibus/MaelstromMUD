...
bool tprg_do_ifchck( char * ifchck, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, CHAR_DATA * rndm );
char *  tprg_process_if( char * ifchck, char * com_list, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, CHAR_DATA * rndm );
void tprg_translate( char ch, char * t, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, CHAR_DATA * rndm );
void tprg_process_cmnd( char * cmnd, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, CHAR_DATA * rndm );
void tprg_driver( char * com_list, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo );
 ...
 */
void tprg_wordlist_check( char * arg, ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, int type ) {
...
void tprg_percent_check( ROOM_INDEX_DATA * room, OBJ_INDEX_DATA * tObj, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, int type ) {
  TRAP_DATA * tprg;
 ...
 * trigger calls.
 */
void tprg_act_trigger( char * buf, CHAR_DATA * mob, CHAR_DATA * ch, OBJ_DATA * obj, void * vo ) {
  /*extern int port;*/
